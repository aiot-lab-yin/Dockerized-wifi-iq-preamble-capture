...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rftap_rftap_encap_1_0 = rftap.rftap_encap(0, (-1), '', '', 1000,  '~/data/mac_address.csv', '~/data/original')
        ...
        self.network_socket_pdu_0 = network.socket_pdu('TCP_SERVER', '127.0.0.1', '52002', 10000, False)
        self.ieee802_11_sync_short_0 = ieee802_11.sync_short(0.6, 8, False, False)
        self.ieee802_11_sync_long_0 = ieee802_11.sync_long(328, False, False)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/78:21:84:93:52:d4_pre_data.csv', True)
        ...
        self.msg_connect((self.ieee802_11_parse_mac_0, 'out'), (self.rftap_rftap_encap_1_0, 'in'))
        self.msg_connect((self.rftap_rftap_encap_1_0, 'out'), (self.network_socket_pdu_0, 'pdus'))
        ...
        self.connect((self.ieee802_11_sync_long_0, 2), (self.blocks_file_sink_1, 0))
        self.connect((self.ieee802_11_sync_long_0, 0), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.ieee802_11_sync_long_0, 1), (self.ieee802_11_frame_equalizer_0, 1))
        self.connect((self.ieee802_11_sync_short_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.ieee802_11_sync_short_0, 0), (self.ieee802_11_sync_long_0, 0))
        self.connect((self.ieee802_11_sync_short_0, 1), (self.ieee802_11_sync_long_0, 2))
