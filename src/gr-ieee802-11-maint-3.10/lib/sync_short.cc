...
public:
                     ...
                     gr_vector_void_star& output_items)
    {
        ...
        gr_complex* out_ori = (gr_complex*)output_items[1];
            ...
            for (i = 0; i < ninput; i++) {
                if (in_cor[i] > d_threshold) {
                    if (d_plateau < MIN_PLATEAU) {
                        ...
                        //dout << "SHORT Frame!"<< d_freq_offset << std::endl;
                        dout << "abs_search" << in_abs[i]<<"freq"<<d_freq_offset<<std::endl;
                        for (int j = i-64;j<=i+32;++j){
                            dout<<in[j]<<"";
                        }
                        dout<<std::endl;
            ...
            while (o < ninput && o < noutput && d_copied < MAX_SAMPLES) {
                if (in_cor[o] > d_threshold) {
                    if (d_plateau < MIN_PLATEAU) {
                        ...
                        //dout << "SHORT Frame!" << d_freq_offset<<std::endl;
                        dout << "abs_copy" << in_abs[o]<<"freq"<<d_freq_offset<<std::endl;
                        for (int j = o-64;j<=o+32;++j){
                            dout<<in[j]<<"";
                        }
                        dout<<std::endl;
